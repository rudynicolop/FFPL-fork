...
From ffpl.type_systems.stlc_extended_sol Require Import lang notation.
...
(* new lemma *)
Lemma canonical_values_pair Gamma e A B :
  Gamma |- e : Prod A B ->
  is_val e ->
...
Lemma type_preservation_base_step e e' A :
  ...
  empty |- e' : A.
Proof.
  intros Hty Hstep. destruct Hstep as [| e1 e2 n1 n2 n3 Heq1 Heq2 Heval | e1 e2 | e1 e2]; subst.
